    ...
    <div className="min-h-screen bg-slate-950 text-white selection:bg-indigo-500/30">
      ...
      <main className="container mx-auto px-6 pt-32 pb-16 text-center max-w-4xl flex flex-col items-center justify-center min-h-[80vh]">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 text-indigo-300 ring-1 ring-indigo-500/20 mb-8 animate-fade-in">
          ...
          <span className="text-sm font-medium">Domainak Registration</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
          ...
          Secure authentication, simple management, and built-in visitor statistics.
        </p>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-left border-t border-slate-800 pt-16">
          {[
            { title: "Instant Setup", desc: "No DNS propagation delays. Your subdomain works the moment you claim it." },
            { title: "Traffic Analytics", desc: "View detailed statistics of your domain traffic daily, weekly, and monthly." },
            { title: "Free Always", desc: "Register domains provided by the platform completely free of charge." }
          ].map((feature, i) => (
